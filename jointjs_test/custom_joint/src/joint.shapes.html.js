(function(joint, util, V) {
    ...
    Element.define('html.Element', {
        ...
        htmlTemplate: `
            <div class="html-element" joint-selector="htmlRoot" style="position: absolute; box-sizing: border-box;" data-attribute="state">
                <label data-attribute="header" class="html-element-header"></label>
                <label class="html-element-label">Name <input data-attribute="name" placeholder="Name" class="html-element-field"></label>
                <label class="html-element-label">Resource 
                    <select data-attribute="resource" placeholder="Resource" class="html-element-field">
